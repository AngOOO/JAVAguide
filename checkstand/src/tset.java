...
interface GoodsCenter {
    ...
    /**
     * 删除商品（通过商品编号）     * @param goodId
     */
    void removeGoods(String goodId);

    /**
     * 更新商品（修改当前商品编号对应商品的名称）     * @param good
     */
    void updateGoods(Goods good);

    /**
     * 商品是否存在（通过商品编号）     * @param goodId     * @return
     */
    boolean isExistGoods(String goodId);

    /**
     * 获取商品（通过商品编号）     * @param goodId     * @return
     */
...
interface OrderCenter {
    ...
    /**
     * 列出当前订单信息（通过订单编号）     * @param orderId     * @return
     */
